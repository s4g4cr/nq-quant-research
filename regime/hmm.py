"""
HMM regime detector (Phases 8–12). Replaced by deterministic filters in Phase 14.
...
DEPRECATION NOTE:
  HMM was used for VWAP (Phases 8-10) and POC (Phase 12). State labels were
  unstable across WFO windows. Phase 14 replaced HMM with deterministic filters
  (F1/F2/F3) that are reproducible and perform better OOS. The confirmed B1
  config uses no HMM. See orb_system/indicators/det_regime.py for the replacement.
"""
import math
import pickle
