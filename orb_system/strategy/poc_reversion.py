"""
POC (Point of Control) Mean Reversion strategy engine  -  Phase 11.

Hypothesis: price extended from POC with an exhaustion candle reverts back.
No regime filter  -  raw structural hypothesis.

Two TP variants:
  A  -  TP = target_poc (prev_poc, or midpoint when confluence)
  B  -  TP = session_poc when confluence, else target_poc

SL = entry +/- sl_mult x ATR(20)
Max 2 trades/session (1L + 1S). EOD exit 15:45 NY.
"""
